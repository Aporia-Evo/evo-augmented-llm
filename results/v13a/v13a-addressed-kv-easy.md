# Generation Benchmark Suite: v13a-addressed-kv-easy
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v4_slots | 2 | 0.000 | 5.500000 | n/a | n/a | 9.50 | 9.00 |
| key_value_memory | 8 | stateful_v5_addressed_slots | 2 | 0.000 | 4.500000 | n/a | n/a | 9.00 | 8.00 |

## Retrieval Metrics

| task | delay | variant | mean_query_accuracy | mean_retrieval_score | mean_query_distance | mean_distractor_load |
| --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v4_slots | 0.458 | 0.640 | 7.333 | 5.333 |
| key_value_memory | 8 | stateful_v5_addressed_slots | 0.375 | 0.622 | 7.333 | 5.333 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v4_slots | 0.500 | 0.458 | -0.101 | -0.208 | 0.742 |
| key_value_memory | 8 | stateful_v5_addressed_slots | 0.417 | 0.375 | -0.133 | -0.234 | 0.755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v4_slots | 0.541 | 0.245 | 0.970 | 1.000 | 0.622 | 0.347 | 0.000 | 0.000 | 0.000 | 0.000 |
