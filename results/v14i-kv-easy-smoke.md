# Generation Benchmark Suite: v14i-kv-easy-smoke
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 1 | 0.000 | 6.215239 | n/a | n/a | 9.00 | 4.00 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.500 | 0.500 | -0.110 | -0.194 | 0.750 |

## KV Selectivity Diagnostics

| task | delay | variant | mean_store_vs_distractor_write_gap | mean_query_value_read_strength |
| --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.000 | 0.363 |
...
| --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.017 | 0.865 | 0.932 | 1.405 |
