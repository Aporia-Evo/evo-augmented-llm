# Generation Benchmark Suite: v15l-B-kv-easy-smoke
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 1 | 0.000 | 6.224891 | n/a | n/a | 9.00 | 6.00 |

## Retrieval Metrics

| task | delay | variant | mean_query_accuracy | mean_retrieval_score | mean_query_distance | mean_distractor_load |
| --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.500 | 0.667 | 7.333 | 5.333 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.500 | 0.500 | -0.110 | -0.187 | 0.777 |

## KV Selectivity Diagnostics

| task | delay | variant | mean_store_vs_distractor_write_gap | mean_query_value_read_strength |
| --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.180 | 0.106 |
...
| --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8 | stateful_v6_delta_memory | 0.045 | 0.807 | 1.344 | 2.208 |
