# Generation Benchmark Suite: v15q-delta
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8->8@g6 | stateful_v6_delta_memory | 5 | 0.000 | 5.050084 | n/a | n/a | 9.20 | 6.40 |

## Retrieval Metrics

| task | delay | variant | mean_query_accuracy | mean_retrieval_score | mean_query_distance | mean_distractor_load |
| --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8->8@g6 | stateful_v6_delta_memory | 0.467 | 0.647 | 6.467 | 4.567 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8->8@g6 | stateful_v6_delta_memory | 0.533 | 0.467 | -0.007 | -0.166 | 0.655 |

## KV Selectivity Diagnostics

| task | delay | variant | mean_store_vs_distractor_write_gap | mean_query_value_read_strength |
| --- | --- | --- | --- | --- |
| key_value_memory | 8->8@g6 | stateful_v6_delta_memory | 0.201 | 0.162 |
...
| --- | --- | --- | --- | --- | --- | --- |
| key_value_memory | 8->8@g6 | stateful_v6_delta_memory | 0.177 | 0.789 | 1.273 | 1.494 |
