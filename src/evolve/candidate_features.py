...
def extract_candidate_features(
    ...
    feature = CandidateFeatureRecord(
        ...
        gate_mean=_coerce_float(metrics.get("gate_mean")),
        gate_variance=_coerce_float(metrics.get("gate_variance")),
        gate_at_store=_coerce_float(metrics.get("gate_at_store")),
        gate_at_distractor=_coerce_float(metrics.get("gate_at_distractor")),
        gate_at_query=_coerce_float(metrics.get("gate_at_query")),
        gate_selectivity=_coerce_float(metrics.get("gate_selectivity")),
        gate_store_minus_query=_coerce_float(metrics.get("gate_store_minus_query")),
        gate_query_minus_distractor=_coerce_float(metrics.get("gate_query_minus_distractor")),
        gate_role_contrast=_coerce_float(metrics.get("gate_role_contrast")),
        slow_state_at_query=_coerce_float(metrics.get("slow_state_at_query")),
        fast_state_at_query=_coerce_float(metrics.get("fast_state_at_query")),
        match_mean=_coerce_float(metrics.get("match_mean")),
        match_variance=_coerce_float(metrics.get("match_variance")),
        match_at_store=_coerce_float(metrics.get("match_at_store")),
        match_at_distractor=_coerce_float(metrics.get("match_at_distractor")),
        match_at_query=_coerce_float(metrics.get("match_at_query")),
        match_selectivity=_coerce_float(metrics.get("match_selectivity")),
        query_match_score=_coerce_float(metrics.get("query_match_score")),
        state_query_alignment=_coerce_float(metrics.get("state_query_alignment")),
        content_retention_gap=_coerce_float(metrics.get("content_retention_gap")),
        mean_key_state=_coerce_float(metrics.get("mean_key_state")),
        mean_value_state=_coerce_float(metrics.get("mean_value_state")),
        key_value_separation=_coerce_float(metrics.get("key_value_separation")),
        query_key_alignment=_coerce_float(metrics.get("query_key_alignment")),
        query_value_read_strength=_coerce_float(metrics.get("query_value_read_strength")),
        store_key_value_coupling=_coerce_float(metrics.get("store_key_value_coupling")),
        distractor_write_leak=_coerce_float(metrics.get("distractor_write_leak")),
        readout_selectivity=_coerce_float(metrics.get("readout_selectivity")),
        mean_key_state_during_store=_coerce_float(metrics.get("mean_key_state_during_store")),
...
def _feature_vector_from_record(record: CandidateFeatureRecord) -> CandidateFeatureVectorRecord:
    vector = [
        ...
        record.gate_mean,
        record.gate_variance,
        record.gate_at_store,
        record.gate_at_distractor,
        record.gate_at_query,
        record.gate_selectivity,
        record.gate_store_minus_query,
        record.gate_query_minus_distractor,
        record.gate_role_contrast,
        record.slow_state_at_query,
        record.fast_state_at_query,
        record.match_mean,
        record.match_variance,
        record.match_at_store,
        record.match_at_distractor,
        record.match_at_query,
        record.match_selectivity,
        record.query_match_score,
        record.state_query_alignment,
        record.content_retention_gap,
        record.mean_key_state,
        record.mean_value_state,
        record.key_value_separation,
        record.query_key_alignment,
        record.query_value_read_strength,
        record.store_key_value_coupling,
        record.distractor_write_leak,
        record.readout_selectivity,
        record.mean_key_state_during_store,
