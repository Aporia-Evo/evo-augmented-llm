...
def test_parse_variants_accepts_stateful_stateless_and_plastic() -> None:
    assert _parse_variants(
        "stateful, stateful_v2, stateful_v2_gated, stateful_v3_kv, stateful_v4_slots, stateful_v6_delta_memory, content_gated, stateless, stateful_plastic, stateful_plastic_hebb, stateful_plastic_ad, "
